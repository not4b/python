...
# You can also customize your own function by using ther keyword argument key = function. 
...
# Luckily we can built-in functions as key functions when sorting a list. 
